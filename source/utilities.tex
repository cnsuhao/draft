...
\pnum
\remarks
The function shall not participate in overload resolution
unless \tcode{is_copy_constructible_v<T>} is \tcode{true}.
\end{itemdescr}
...
The function shall not participate in overload resolution
unless \tcode{is_copy_constructible_v<T> \&\&} \tcode{is_copy_assignable_v<T>} is \tcode{true}.
\end{itemdescr}
...
The function shall not participate in overload resolution
unless \tcode{is_move_constructible_v<T> \&\&} \tcode{is_move_assignable_v<T>} is \tcode{true}.
\end{itemdescr}
...
The function shall not participate in overload resolution
unless \tcode{is_same_v<decay_t<U>, T> \&\&} \tcode{is_constructible_v<T, U> \&\&}
